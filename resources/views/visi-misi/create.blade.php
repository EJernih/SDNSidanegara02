...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-12">
            <form id="visimisiForm" action="{{ route ('visimisis.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <textarea name="visi" id="" cols="30" rows="10" class="form-control" placeholder="Visi"></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="misi" id="" cols="30" rows="10" class="form-control" placeholder="Misi"></textarea>
                </div>
        ...
        document.getElementById('submitBtn').addEventListener('click', function(event) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    document.getElementById('visimisiForm').submit();
                }
            });
        });
    });
